...
function Home() {
  ...
  return loading ? (<Loader/>) : (
    <div>
        <video className="fixed top-0 left-0 w-full h-[100vh] object-cover -z-10" autoPlay loop muted>
    ...
    <div className="home relative z-10">
        <div className="w-full h-20 px-4 flex items-center justify-between md:justify-end bg-transparent">
            ...
            <ul className="hidden md:block lg:text-2xl text-white font-medium">
                <li className="hover:text-yellow-400"> <p>contact@paperwork.studio</p> </li>
                <li className="hover:text-yellow-400"> <p> @paperwork</p></li>            
            </ul>
        </div>
        ...
        <div className="flex items-start justify-between flex-col gap-[80px] md:flex-row">
            <h1 className="text-base md:text-xs text-left">PAPERWORK STUDIO IS A
            MULTIMEDIA CREATIVE CONSULTING AND PRODUCTION COMPANY.</h1>
        ...
        <div className="projects px-7 w-full bg-transparent grid">
            <ProjectCard/>
            <ProjectCard/>
            <ProjectCard/>
            <ProjectCard/>
